...
namespace CoreFrame.Util
{
    ...
    public abstract class DbHelper
    {
        ...
        public virtual void SaveEntityToFile(List<TableInfo> infos, string tableName, string tableDescription, string filePath, string nameSpace, string schemaName = null)
        {
            ...
            TypeDict.Add("Byte", "byte");
            TypeDict.Add("Char", "char");
            TypeDict.Add("Decimal", "decimal");
            TypeDict.Add("Double", "double");
            TypeDict.Add("Single", "float");
            TypeDict.Add("Int32", "int");
            TypeDict.Add("Int64", "long");
            TypeDict.Add("UInt32", "uint");
            TypeDict.Add("UInt64", "ulong");
            TypeDict.Add("Int16", "short");
            TypeDict.Add("UInt16", "ushort");
        ...
        [Key]" : "";
                ...
                string itemType = type.Name;
                if (TypeDict.ContainsKey(type.Name))
                {
                    itemType = TypeDict[type.Name];
                }
...
$@"
        ...
        /// {description}
        /// </summary>{isKey}
        public {itemType}{isNullable} {item.Name} {{ get; set; }}
";
