...
namespace CoreFrame.Business
{
    ...
    public class BaseBusiness<T> : IRepository<T> where T : class, new()
    {
        ...
        {
            Repository = DbFactory.GetRepository(param, dbType, entityNamespace);
        }
        ...
        {
            return Repository.EndTransaction();
        }
        ...
        {
            return Repository.Delete<T>(key);
        }
        ...
        public virtual int  Delete(List<int> keys)
        {
            return Repository.Delete<T>(keys);
        }
        /// <summary>
        /// 删除一条记录
        /// </summary>
        ...
        public virtual void UpdateAny(T entity, List<string> properties)
        {
        ...
        /// <param name="entities">数据列表</param>
        /// <param name="properties">需要更新的字段</param>
        public virtual void UpdateAny(List<T> entities, List<string> properties)
        {
            Repository.UpdateAny(entities, properties);
        }
        ...
        public virtual void UpdateWhere(Expression<Func<T, bool>> whereExpre, Action<T> set)
        {
            Repository.UpdateWhere(whereExpre, set);
        }
        ...
        /// <returns></returns>
        public virtual T GetEntity(params object[] keyValue)
        {
            return Repository.GetEntity<T>(keyValue);
        }
        ...
        /// <returns></returns>
        public virtual IQueryable<T> GetIQueryableList(Expression<Func<T, bool>> predicate)
        {
            return Repository.GetIQueryableList(predicate);
        }
            /// <summary>
            /// 获取数据列表
            /// </summary>
            ...
            /// <returns></returns>
            public virtual List<T> GetDataList(string condition, string keyword, Pagination pagination)
        {
            var q = GetIQueryable();
        ...
        {
            return Repository.GetDataTableWithSql(sql);
        }
        ...
        {
            return Repository.GetDataTableWithSql(sql, parameters);
        }
        ...
        /// </summary>
        /// <param name="sql">Sql语句</param>
        public virtual void ExecuteSql(string sql, List<DbParameter> parameters)
        {
            Repository.ExecuteSql(sql, parameters);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual AjaxResult Success()
        {
        ...
        /// <returns></returns>
        public virtual AjaxResult Success(string msg)
        {
            AjaxResult res = new AjaxResult
            {
                Success = true,
        ...
        /// <returns></returns>
        public virtual AjaxResult Success(object data)
        {
            AjaxResult res = new AjaxResult
            {
                Success = true,
        ...
        /// <param name="data">返回的数据</param>
        /// <returns></returns>
        public virtual AjaxResult Success(string msg, object data)
        {
            AjaxResult res = new AjaxResult
            {
                Success = true,
        ...
        /// </summary>
        /// <returns></returns>
        public virtual AjaxResult Error()
        {
            AjaxResult res = new AjaxResult
            {
                Success = false,
        ...
        /// <returns></returns>
        public virtual AjaxResult Error(string msg)
        {
            AjaxResult res = new AjaxResult
            {
                Success = false,
        ...
        {
            SQLLogHelper.WriteSysLog(logContent, logType);
        }
